...
add_action( 'manage_cp_speakers_posts_custom_column' , __NAMESPACE__.'\\sepaker_thumbnail_column' , 2 , 10 );
add_filter( 'manage_cp_speakers_posts_columns' ,__NAMESPACE__.'\\add_speaker_thumbnail_to_column' , 1 , 10 );
